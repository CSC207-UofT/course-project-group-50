...
public class Director {
    ...
    /* TODO: The main benefit of using a Builder pattern is for extensible design.
    ...
    /* TODO: In future versions, should edit the Builder pattern to direct different elements of game setup
        ...
        More sophisticated methods will be added as we settle on data structs for storing/reading/handling board data
            1. change the interface for City, so that the BoardBuilder manages the colour blocks separately
