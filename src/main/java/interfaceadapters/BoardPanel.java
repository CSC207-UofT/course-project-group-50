...
public class BoardPanel extends JPanel {
    ...
    public void update(int numOfPlayers, Map<String, TileData> boardData, Map<Integer, Color> playerToColour,
    ...
    private void refreshBoard(Map<String, TileData> boardData, Map<Integer, Color> playerToColour,
