...
public class DisplayPanel extends JPanel {
    ...
    private void constantSetUp(Map<Integer, PlayerData> playerData){
    ...
    private void initializeMaps(Map<String, TileData> boardData, Map<Integer, PlayerData> playerData){
        for (int i = 1; i <= numOfPlayers; i++) {
